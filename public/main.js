(() => {
  ...
  function j(n2, u2, i2, t2, o3, r2, f2, e2, c2) {
    var a2, h2, v2, y, _3, k2, b2, g2, m2, x, A2, C2, $2, H2, I2, T2 = u2.type;
    ...
    try {
      n:
        if ("function" == typeof T2) {
          ...
          h2.state = h2.__s, null != h2.getChildContext && (t2 = s(s({}, t2), h2.getChildContext())), v2 || null == h2.getSnapshotBeforeUpdate || (k2 = h2.getSnapshotBeforeUpdate(y, _3)), I2 = null != a2 && a2.type === p && null == a2.key ? a2.props.children : a2, w(n2, Array.isArray(I2) ? I2 : [I2], u2, i2, t2, o3, r2, f2, e2, c2), h2.base = u2.__e, u2.__h = null, h2.__h.length && f2.push(h2), b2 && (h2.__E = h2.__ = null), h2.__e = false;
        } else
  ...
  function N(n2, u2, i2) {
    ...
    if (t2 = n2.__k)
      for (o3 = 0; o3 < t2.length; o3++)
        t2[o3] && N(t2[o3], u2, i2 || "function" != typeof n2.type);
  ...
  var Main = () => /* @__PURE__ */ o2("div", {
    children: "My Main Application here will be router"
  });

  // src/frontend/index.tsx
  var $documentBody = document.getElementById("app");
  if ($documentBody) {
    P(/* @__PURE__ */ o2(Main, {}), $documentBody);
  }
})();
