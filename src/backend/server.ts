...
const initialValue = async () => {
	...
	await Article.create({ title: 'Rodzaje terapii. Którą wybrać?', description: 'Właściwy wybór terapii psychologicznej jest ważny dla naszego samopoczucia i realizacji celu. Sprawdź, czym różnią się poszczególne nurty psychoterapii i jaki będzie najlepszy...', icon: 'kogowybrac.jpg', data: arts, category: ArtType.mental })
